//#region node_modules/.pnpm/@swup+plugin@4.0.0/node_modules/@swup/plugin/dist/index.modern.js
function r() {
...
var n = (r) => String(r).split(".").map((r) => String(parseInt(r || "0", 10))).concat(["0", "0"]).slice(0, 3).join(".");
var e = class {
	constructor() {
			...
			if (!function(r, e, t) {
				...
				return !!s && ((r, e) => e.every((e) => {
					...
					return ((r, n) => {
						...
						return (e[n] || e[""])(r);
					})((i = s, o = n(o = r), i = n(i), o.localeCompare(i, void 0, { numeric: !0 })), t || ">=");
				}))(s, e);
	...
	once(n, e, t = {}) {
		return this.on(n, e, r({}, t, { once: !0 }));
	}
	before(n, e, t = {}) {
		return this.on(n, e, r({}, t, { before: !0 }));
	}
	replace(n, e, t = {}) {
		return this.on(n, e, r({}, t, { replace: !0 }));
	}
	off(r, n) {

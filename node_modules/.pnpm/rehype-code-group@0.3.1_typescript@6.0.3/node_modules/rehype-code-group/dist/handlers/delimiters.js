 ...
 */
export const handleStartDelimiter = (node, index, parent, codeGroups) => {
 ...
 */
export const handleEndDelimiter = (index, parent, codeGroups, classNames) => {
    const codeGroup = codeGroups.pop();
    const endIndex = index;
    if (codeGroup && codeGroup.parentNode === parent) {
        const { parentNode, startIndex } = codeGroup;
        const rehypeCodeGroupElement = createRehypeCodeGroupElement(codeGroup, endIndex, classNames);
        parentNode.children.splice(startIndex, endIndex - startIndex + 1, rehypeCodeGroupElement);
        return {
            found: true,
